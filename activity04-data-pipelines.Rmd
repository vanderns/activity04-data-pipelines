...
**Response**: We need majors and unemployment rates that go with them. In Python I would attempt to use major[np.argmin(unemployment_rate)] and in SAS I could use proc sort by unemployment_rate desc;
...
**Response**: Mathematics And Computer Science has the lowest unemployment rate
...
**Response**: Well Physical Sciences is the only STEM major in there and it makes over the median
